...
impl RustHydrusApiClient {
    ...
    pub fn loaded_scraper_folder(&self) -> Result<PathBuf, ureq::Error> {
        ...
        let response_bytes = ureq::get(url)
            ...
            .read_to_vec()?;
        let res: PathBuf =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn delete_namespace_id(&self, nsid: &u64) -> Result<(), ureq::Error> {
        ...
        let payload = bitcode::serialize(&(nsid)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
    ...
    pub fn check_default_source_urls(
        ...
        let payload = bitcode::serialize(&(action)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn del_from_jobs_byid(&self, id: Option<u64>) -> Result<(), ureq::Error> {
        ...
        let payload = bitcode::serialize(&(id)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    ///
    pub fn file_add(&self, file: sharedtypes::DbFileStorage) -> Result<u64, ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "file_add");
        let payload = bitcode::serialize(&(file)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn storage_put(&self, location: &String) -> Result<u64, ureq::Error> {
        ...
        let payload =
            bitcode::serialize(&(location)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn delete_tag(&self, tag: &u64) -> Result<(), ureq::Error> {
        ...
        let payload = bitcode::serialize(&(tag)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn parents_tagid_remove(
        ...
        let payload = bitcode::serialize(&(tagid)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
            .into_body()
            .read_to_vec()?;
        let res: HashSet<sharedtypes::DbParentsObj> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn add_relationship(&self, file: &u64, tag: &u64) -> Result<(), ureq::Error> {
        ...
        let payload =
            bitcode::serialize(&(file, tag)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn check_relationship_exists(
        ...
        let payload =
            bitcode::serialize(&(file_id, tag_id)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn tag_add_tagobject_multiple(
        ...
        let payload =
            bitcode::serialize(&(tag_list)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    /// Sets a relationship between a fileid old and new tagid
    pub fn migrate_tag(&self, old_tag_id: &u64, new_tag_id: &u64) -> Result<(), ureq::Error> {
    ...
    pub fn parents_selective_remove(
        ...
        let url = format!(
            "{}/{}/{}",
            self.base_url, "main", "parents_selective_remove"
        );
        let payload =
            bitcode::serialize(&(parentobj)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn parents_add(&self, par: sharedtypes::DbParentsObj) -> Result<u64, ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "parents_add");
        let payload = bitcode::serialize(&(par)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn load_table(&self, table: &sharedtypes::LoadDBTable) -> Result<(), ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "load_table");
        let payload = bitcode::serialize(&(table)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn add_dead_url(&self, url_string: &String) -> Result<(), ureq::Error> {
        ...
        let payload =
            bitcode::serialize(&(url_string)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn search_tags(
        ...
        let response_bytes = ureq::post(url)
            ...
            .into_body()
            .read_to_vec()?;
        let res: Vec<(sharedtypes::Tag, u64, u64)> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn relationship_get_fileid(&self, tag: &u64) -> Result<HashSet<u64>, ureq::Error> {
    ...
    pub fn relationship_get_one_fileid(&self, tag: &u64) -> Result<Option<u64>, ureq::Error> {
        let url = format!(
            "{}/{}/{}",
    ...
    pub fn relationship_get_tagid(&self, file_id: &u64) -> Result<HashSet<u64>, ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "relationship_get_tagid");
        let payload =
            bitcode::serialize(&(file_id)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn settings_get_name(
        ...
        let payload = bitcode::serialize(&(name)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
            .into_body()
            .read_to_vec()?;
        let res: Option<sharedtypes::DbSettingObj> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    ///
    pub fn jobs_update_db(&self, jobs_obj: sharedtypes::DbJobsObj) -> Result<(), ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "jobs_update_db");
        let payload =
            bitcode::serialize(&(jobs_obj)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    ///
    pub fn jobs_add_new(&self, jobs_obj: sharedtypes::DbJobsObj) -> Result<u64, ureq::Error> {
    ...
    pub fn check_dead_url(&self, url_to_check: &String) -> Result<bool, ureq::Error> {
        ...
        let payload =
            bitcode::serialize(&(url_to_check)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn jobs_get_isrunning(&self) -> Result<HashSet<sharedtypes::DbJobsObj>, ureq::Error> {
        ...
        let response_bytes = ureq::get(url)
            ...
            .into_body()
            .read_to_vec()?;
        let res: HashSet<sharedtypes::DbJobsObj> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn search_db_files(
        ...
        let payload =
            bitcode::serialize(&(search, limit)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
            .into_body()
            .read_to_vec()?;
        let res: Option<Vec<u64>> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    /// Gets all jobs loaded in the db
    pub fn jobs_get_all(&self) -> Result<HashMap<u64, sharedtypes::DbJobsObj>, ureq::Error> {
        ...
        let response_bytes = ureq::get(url)
            ...
            .into_body()
            .read_to_vec()?;
        let res: HashMap<u64, sharedtypes::DbJobsObj> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    /// Pull job by id TODO NEEDS TO ADD IN PROPER POLLING FROM DB.
    pub fn jobs_get(&self, id: &u64) -> Result<Option<sharedtypes::DbJobsObj>, ureq::Error> {
        ...
        let response_bytes = ureq::post(url)
            ...
            .into_body()
            .read_to_vec()?;
        let res: Option<sharedtypes::DbJobsObj> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    /// Gets a tag by id
    pub fn tag_id_get(&self, uid: &u64) -> Result<Option<sharedtypes::DbTagNNS>, ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "tag_id_get");
        let payload = bitcode::serialize(&(uid)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
            .into_body()
            .read_to_vec()?;
        let res: Option<sharedtypes::DbTagNNS> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn extension_get_string(&self, ext_id: &u64) -> Result<Option<String>, ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "extension_get_string");
        let payload = bitcode::serialize(&(ext_id)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn file_get_hash(&self, hash: &String) -> Result<Option<u64>, ureq::Error> {
        ...
        let payload = bitcode::serialize(&(hash)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn file_get_id(
        ...
        let response_bytes = ureq::post(url)
            ...
            .into_body()
            .read_to_vec()?;
        let res: Option<sharedtypes::DbFileStorage> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn file_get_list_all(
        ...
        let response_bytes = ureq::get(url)
            ...
            .into_body()
            .read_to_vec()?;
        let res: HashMap<u64, sharedtypes::DbFileStorage> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    /// Gets a tagid from a unique tag and namespace combo
    pub fn tag_get_name(&self, tag: String, namespace: u64) -> Result<Option<u64>, ureq::Error> {
        let url = format!("{}/{}/{}", self.base_url, "main", "tag_get_name");
        let payload =
            bitcode::serialize(&(tag, namespace)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn tag_get_name_tagobject(
        ...
        let payload = bitcode::serialize(&(tagobj)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn namespace_get(&self, namespace: &String) -> Result<Option<u64>, ureq::Error> {
        ...
        let payload =
            bitcode::serialize(&(namespace)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn namespace_get_string(
        ...
        let payload = bitcode::serialize(&(ns_id)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
            .into_body()
            .read_to_vec()?;
        let res: Option<sharedtypes::DbNamespaceObj> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn namespace_get_tags_from_fileid(
        ...
        let payload =
            bitcode::serialize(&(ns_id, file_id)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
            .into_body()
            .read_to_vec()?;
        let res: Vec<sharedtypes::DbTagNNS> =
            bitcode::deserialize(&response_bytes).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        Ok(res)
    }
    ...
    pub fn parents_get(
        ...
        let payload = bitcode::serialize(&(parent)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn parents_rel_get(&self, relid: &u64) -> Result<HashSet<u64>, ureq::Error> {
        ...
        let payload = bitcode::serialize(&(relid)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
    ...
    pub fn namespace_add_id_exists(
        ...
        let payload = bitcode::serialize(&(ns)).map_err(|e| ureq::Error::Other(Box::new(e)))?;
        let response_bytes = ureq::post(url)
            .header("content-type", "application/bitcode")
            .header("accept", "application/bitcode")
            .send(payload)?
